...
<body>
  ...
  <h1 class="titulo">Formulário de Registro</h1>
    <div class="wrapper">
      <form class="form-signin">
        ...
        <p><input type="submit" class="btn btn-lg btn-secondary btn-block btn-center" value="Registar"> <a class="url-login" href="login/index.html">Faça seu login</a></p>

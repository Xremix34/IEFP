...
<form id="actualizar">
        ...
        <p>
          <label>Genero</label>
          <input type="text" value="<?php echo $consulta_de_dados['genero'];?>">
          <?php
          $conn = conectar_bd();
        ...
        <p>Password: <input type="password" name="password" placeholder="Introduza a password" value="<?php echo $consulta_de_dados['password']; ?>"></p>
              <input type="hidden" value = "<?php echo $_SESSION['id_utilizador'];?>" name="id_utilizador">;
        <p><input type="submit" name="atualizar"></p>
        <p>Api Key: <input type="text" name="apikey" placeholder="Introduza a ApiKey" value="<?php echo $consulta_de_dados['apikey']; ?>"></p>
      </form>
